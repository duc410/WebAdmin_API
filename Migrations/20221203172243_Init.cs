    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Role2Rights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Role2Rights_Rights_RightId",
                        column: x => x.RightId,
                        principalTable: "Rights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Role2Rights_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Role2Rights_RightId",
                table: "Role2Rights",
                column: "RightId");

            migrationBuilder.CreateIndex(
                name: "IX_Role2Rights_RoleId",
                table: "Role2Rights",
                column: "RoleId");
